...
// loads the specified object schema defined in <obj_type>.json
...
// validates the the object map matches the schema
...
// check that the object type is supported
...
// build an object and adds it to database
...
// reads an object, checks cache first and if not found, adds to to the cache
